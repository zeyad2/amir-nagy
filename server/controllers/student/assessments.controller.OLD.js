...
export const startAssessmentAttempt = async (req, res) => {
  try {
    ...
    // First, determine if this is a test or homework by checking both tables
    ...
    if (test) {
      // For tests, we need to find the CourseTest first, then check submission
      // We can't directly query by testId, we need to find via CourseTest
