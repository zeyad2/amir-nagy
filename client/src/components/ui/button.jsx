...
// Helper function to generate button variant classes (compatible with shadcn/ui pattern)
const buttonVariants = ({ variant = "default", size = "default" } = {}) => {
  const safeVariant = buttonVariantClasses[variant] || buttonVariantClasses.default
  const safeSize = buttonSizeClasses[size] || buttonSizeClasses.default
